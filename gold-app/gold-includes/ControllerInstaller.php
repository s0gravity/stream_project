	...
	static function gold_settings($type) {
		...
		if($type == 'insert') {
			return mysql_query("
				...
				(8, 'gold_website_title', 'Movies Online - Gold MOVIES'),
				(9, 'gold_website_description', 'Watch HD Movies Online - Gold MOVIES'),
				(10, 'gold_website_keywords', 'Movies, Online, HD, Movies Online, Gold Movies'),
